...
/**
 * Created by TekSliveron 8/21/2018.
 */
public class TeacherController {
    ...
    private ObservableList<TeacherTableData> getDataFromTeacherTableDataAndAddToObservableList(String query) {
    ...
    private void initialize(){
        ...
        String [] teacherSecs=null;
        	String	teacherSec=null;
    ...
    private void setTeacherAddGPAClick(Event event){
        ...
        if (!teacherTFAttendance.getText().isEmpty()&& attendance <=5.0&&
            ...
            try {
                ...
                e.printStackTrace();
                gpaAddResult.setText("error ");
                gpaAddResult.setFont(Font.font ("Verdana", 20));
                gpaAddResult.setFill(Color.RED);
            }

            gpaAddResult.setText("Cgpa add Successfully");
            gpaAddResult.setFont(Font.font ("Verdana", 20));
            gpaAddResult.setFill(Color.LIMEGREEN);
