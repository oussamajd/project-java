...
public class TeacherTableData {
    private SimpleStringProperty teacherTableDataID;
    private SimpleStringProperty teacherTableDataName;
    private SimpleStringProperty teacherTableDataGPA;
    private SimpleStringProperty teacherTableDataPhone;
    private SimpleStringProperty teacherTableDataEmail;
