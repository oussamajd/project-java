...
/**
 * Created by TekSliveron 7/25/2018.
 */
public class AdminTable {
    private SimpleIntegerProperty adminTableDataNo;
    private SimpleStringProperty adminTableDataStudentName;
    private SimpleStringProperty adminTableDataStudentID;
    private SimpleStringProperty adminTableDataStudentDepartment;
    private SimpleDoubleProperty adminTableDataStudentCGPA;
    private SimpleStringProperty adminTableDataStudentPhone;
    private SimpleStringProperty adminTableDataStudentDOB;
    private SimpleStringProperty adminTableDataGuardianName;
    private SimpleStringProperty adminTableDataGuardianEmail;
    private SimpleStringProperty adminTableDataGuardianPhone;
    private SimpleStringProperty adminTableDataStudentAddress;
