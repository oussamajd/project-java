...
public class Admin implements Initializable {
    ...
    private ObservableList<AdminTable> getDataFromSqlAndAddToObservableList(String query){
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        adminTableView.setItems(getDataFromSqlAndAddToObservableList("SELECT * FROM student;"));//add_query
    ...
    private void setAdminSearchButtonClick(Event event){
        String sqlQuery = "select * FROM student where CONCAT(dbStudentID,dbStudentFname,dbStudentLname) like'%" + adminTFSearch.getText() + "%';";//add query
    ...
    private void setAdminEditButtonClick(Event event){
        ...
        String sqlQuery = "select * FROM student where dbStudentID = '" + getSelectedRow.getAdminTableDataStudentID() + "';";//add query
    ...
    private void setAdminDeleteButtonClick(Event event){
        ...
        AdminTable getSelectedRow = adminTableView.getSelectionModel().getSelectedItem();
        String sqlQuery = "delete from student where dbStudentID = '" + getSelectedRow.getAdminTableDataStudentID() + "';";//add query
        try {
            connection = database.getConnection();
            statement = connection.createStatement();

            statement.executeUpdate(sqlQuery);
            statement.executeUpdate("delete from studentgpa where dbstudentgpaID ='" + getSelectedRow.getAdminTableDataStudentID() + "';");//add query
            adminTableView.setItems(getDataFromSqlAndAddToObservableList("SELECT * FROM student;"));
        }
        catch (SQLException e) {
            e.printStackTrace();
