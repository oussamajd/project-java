        ...
        //add code
    	 try {
             ...
             while (resultSet.next()) {
                 name = String.valueOf(resultSet.getString("dbStudentFname")) + " " + resultSet.getString("dbStudentLname");
                 department = resultSet.getString("dbStudentDepartment");
                 cgpa = resultSet.getString("dbStudentCgpa");
                 vemail = String.valueOf(name.substring(0, 1)) + resultSet.getString("dbStudentLname") + id.substring(3) + "@bs" + department.toLowerCase() + ".uiu.ac.bd";
                 ...
                 gname = String.valueOf(resultSet.getString("dbGuardianFname")) + " " + resultSet.getString("dbGuardianLname");
